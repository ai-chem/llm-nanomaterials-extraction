...
try:
    from graph_processing.image_reasoning_dataset import analyze_image_for_dataset, extract_table_dataset_specific
    from graph_processing.dataset_prompts import map_folder_to_dataset_type
    from graph_processing.vlm_config import VLMProvider
except ImportError:
